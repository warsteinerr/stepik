...
class TestAbs(unittest.TestCase):
    ...
    def test_registration1(self):
        ...
        input2 = self.browser.find_element(By.NAME, 'last_name')
        input2.send_keys("Петров")
        input3 = self.browser.find_element(By.CLASS_NAME, 'city')
        ...
        self.assertEqual("Поздравляем! Вы успешно зарегистрировались!", welcome_text)
